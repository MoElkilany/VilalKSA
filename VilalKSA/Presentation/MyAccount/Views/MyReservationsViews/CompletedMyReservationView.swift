//
//  CompletedMyReservationView.swift
//  VilalKSA
//
...
struct CompletedMyReservationContainerView: View {
    ...
    var body: some View {
        CompletedMyReservationView(model: model,cancelRequest:cancelRequest,receipt:receipt)
...
struct CompletedMyReservationView: View {
    let model: MyReservationModel
    let cancelRequest: (()->())?
    let receipt: (()->())?
